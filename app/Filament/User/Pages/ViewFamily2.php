...
class ViewFamily2 extends Page implements HasTable,HasForms
{
    ...
    protected static ?string $navigationLabel='عرض للضحايا بالصور (ثنائية)';
